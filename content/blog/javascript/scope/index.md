...
# [#](https://www.blog.alalshow.com/javascript/scope#2-스코프의-구분)2. 스코프의 구분
...
# [#](https://www.blog.alalshow.com/javascript/scope#3-자바스크립트-스코프의-특징)3. 자바스크립트 스코프의 특징
...
# [#](https://www.blog.alalshow.com/javascript/scope#4-전역-스코프global-scope)4. 전역 스코프(Global scope)
...
전역 변수의 사용은 [변수 이름이 중복](https://www.blog.alalshow.com/javascript/scope#9-변수-이름의-중복)될 수 있고, **의도치 않은 재할당에 의한 상태 변화로 코드를 예측하기 어렵게 만드므로 사용을 억제하여야 한다.**

# [#](https://www.blog.alalshow.com/javascript/scope#5-비-블록-레벨-스코프non-block-level-scope)5. 비 블록 레벨 스코프(Non block-level scope)
...
# [#](https://www.blog.alalshow.com/javascript/scope#6-함수-레벨-스코프function-level-scope)6. 함수 레벨 스코프(Function-level scope)
...
# [#](https://www.blog.alalshow.com/javascript/scope#7-렉시컬-스코프)7. 렉시컬 스코프
...
# [#](https://www.blog.alalshow.com/javascript/scope#8-암묵적-전역-변수)8. 암묵적 전역 변수
...
# [#](https://www.blog.alalshow.com/javascript/scope#9-변수-이름의-중복)9. 변수 이름의 중복
...
# [#](https://www.blog.alalshow.com/javascript/scope#10-최소한의-전역변수-사용)10. 최소한의 전역변수 사용
...
# [#](https://www.blog.alalshow.com/javascript/scope#11-즉시실행함수를-이용한-전역변수-사용-억제)11. 즉시실행함수를 이용한 전역변수 사용 억제
...
- [poiemaweb-scope](https://www.blog.alalshow.com/javascript/scope)